...
//void UnitRenderer::add(const EntityPtr &form)
//{
...
//    for (EntityPtr form : forms_) {
//        if (form->data.Type < genie::Unit::BuildingType) {
//            continue;
//        }

//        std::vector<std::shared_ptr<res::Graphic>> graphics = form->currentGraphics().graphic_->getDeltas();
//        graphics.push_back(form->currentGraphics().graphic_);

//        for (const res::GraphicPtr graphic : graphics) {
//            ScreenPos pos = renderTarget_->absoluteScreenPos(form->position) - graphic->getHotspot() - graphic->offset_;
//            sf::Texture texture;
...
//        if (form->selected) { // draw health indicator
//            ScreenPos pos = renderTarget_->absoluteScreenPos(form->position);
...
//            continue;
//        }
////        form->graphics->drawOn(*renderTarget_);
////        renderTarget_->draw(form->graphics->graphic_, form->position, form->graphics->current_frame_);
////        draw(graph->getImage(form->graphics, angle), pos - form->graphics->getHotspot(frame));

////        comp::GraphicPtr graph = form.getComponent<comp::GraphicRender>(comp::GRAPHIC_RENDER);
//        ScreenPos pos = renderTarget_->absoluteScreenPos(form->position) - form->currentGraphics()->getHotspot() - form->currentGraphics()->graphic_->offset_;

//        sf::Texture texture;
//        texture.loadFromImage(form->currentGraphics()->overlay());
//        sf::Sprite sprite;
//        sprite.setTexture(texture);
//        sprite.setPosition(pos);
