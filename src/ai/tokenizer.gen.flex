...
"disable-self"    { RET_TOKEN(DisableSelf) }
"my-player-number"    { RET_TOKEN(ConstantMyPlayerNumber) }
"my-civ"    { RET_TOKEN(ConstantMyCiv) }
"my-unique-unit"    { RET_TOKEN(ConstantMyUniqueUnit) }
"my-unique-unit-upgrade"    { RET_TOKEN(ConstantMyUniqueUnitUpgrade) }
"my-unique-unit-line"    { RET_TOKEN(ConstantMyUniqueUnitLine) }
"my-elite-unique-unit"    { RET_TOKEN(ConstantMyEliteUniqueUnit) }
"my-unique-research"    { RET_TOKEN(ConstantMyUniqueResearch) }
